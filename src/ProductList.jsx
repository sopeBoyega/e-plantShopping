...
function ProductList() {
    ...
    const quantityOfCartItems= itemsInCart.length
    const plantsArray = [
        {
    ...
    <div key={index}>
        ...
        <div className="product-list">
            ...
            <div className="product-card" key={plantIndex}>
                ...
                <button  className={`product-button ${itemsInCart.some(item => item.name === plant.name) ? 'btn-disabled' : ''}`} onClick={() => handleAddToCart(plant)} >{itemsInCart.some(item => item.name === plant.name) ? 'Added' : 'Add to Cart'}</button>
            </div>
            ))}
        </div>
    </div>
